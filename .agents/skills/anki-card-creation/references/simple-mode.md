...
- The complete Markdown file, including links and citations, must contain **at most 2,500 Unicode characters**. Count it with the bundled validator; do not treat bytes or words as characters.
...
Any result above 2,500 characters or without a valid local visual is a failure.
