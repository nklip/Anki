...
- **Approach:** Use database `auto_increment` with step increments (e.g., `+k` for k servers).
    ...
    <p align="left">
    <img src="./images/multi-master.svg" alt="Multi Master" width="1000">
    </p>
...
- **Approach:**
    ...
    - UUIDs can be generated independently without coordination between servers
        ...
        <p align="left">
        <img src="./images/uuid.svg" alt="UUID generator" width="1000">
        </p>
...
- **Approach:** Use a centralized database server to increment and assign IDs.
    ...
    <p align="left">
    <img src="./images/ticket-server.svg" alt="UUID generator" width="1000">
    </p>
...
- **Approach:**
    ...
    <div style="margin-left:3rem">
      <img src="./images/twitter-snowflake.svg" alt="Snowflake approach" width="1000">
    </div>
    <div style="margin-left:3rem">
      <img src="./images/snowflake-id-breakdown.svg" alt="Snowflake ID breakdown" width="1000">
    </div>
