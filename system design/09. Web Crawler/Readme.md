...
<p align="center">
<img src="./images/visual-process.svg" alt="visial example of the crawl process" width="1000">
</p>
...
### Components
<p align="center">
<img src="./images/web-crawler-architecture.svg" alt="Web Crawler Architecture" width="1000">
</p>
...
<p align="center">
<img src="./images/web-crawler-workflow.svg" alt="Web Crawler Workflow" width="1000">
</p>
...
- **Politeness:**
    ...
    - Each downloader thread has a separate FIFO queue and only downloads URLs from that queue.
        ...
        <img src="./images/politeness.svg" alt="Politeness" width="1000">
...
- **Priority:**
    - Assign higher priority to important pages (e.g., by PageRank or update frequency).
        ...
        <img src="./images/prioritizer.svg" alt="Prioritizer" width="1000">
...
- Example: Plug in a module to monitor web content for copyright violations.
    ...
    <img src="./images/extensibility.svg" alt="Extensibility" width="1000">
---
