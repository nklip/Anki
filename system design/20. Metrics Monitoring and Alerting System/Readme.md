...
<div style="margin-left:3rem">
    <img src="./images/metrics-monitoring-core-components.svg" alt="metrics-monitoring-core-components" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/metrics-example-1.svg" alt="metrics-example-1" width="1000" />
</div>

The data can be identified by the following table:

<div style="margin-left:3rem">
    <img src="./images/metrics-example-1-data.svg" alt="metrics-example-1-data" width="1000" />
</div>
...
The format shown above is called the line protocol and is used by many popular monitoring products on the market, e.g., Prometheus and OpenTSDB.

What every time series consists of:

<div style="margin-left:3rem">
    <img src="./images/time-series-data-example.svg" alt="time-series-data-example" width="1000" />
</div>

A good way to visualize how data looks like:

<div style="margin-left:3rem">
    <img src="./images/time-series-data-viz.svg" alt="time-series-data-viz" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/influxdb-scale.svg" alt="influxdb-scale" width="1000" />
</div>
...
It is critical, however, to keep the cardinality of labels low - i.e., not use too many unique labels.
...
<div style="margin-left:3rem">
    <img src="./images/pull-model-example.svg" alt="pull-model-example" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/service-discovery-example.svg" alt="service-discovery-example" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/push-model-example.svg" alt="push-model-example" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/metrics-collector-agent.svg" alt="metrics-collector-agent" width="1000" />
</div>
...
So which one is better? There are trade-offs between both approaches, and different systems use different approaches:
 ...
 - Amazon CloudWatch and Graphite use a push architecture.
...
<div style="margin-left:3rem">
    <img src="./images/metrics-transmission-pipeline.svg" alt="metrics-transmission-pipeline" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/queuing-mechanism.svg" alt="queuing-mechanism" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/metrics-collection-kafka.svg" alt="metrics-collection-kafka" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/cache-layer-query-service.svg" alt="cache-layer-query-service" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/double-delta-encoding.svg" alt="double-delta-encoding" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/alerting-system.svg" alt="alerting-system" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/grafana-dashboard.svg" alt="grafana-dashboard" width="1000" />
</div>
