...
<div style="margin-left:3rem">
    <img src="./images/digital-advertising-example.svg" alt="digital-advertising-example" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/high-level-design-1.svg" alt="high-level-design-1" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/high-level-design-2.svg" alt="high-level-design-2" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/atomic-commit.svg" alt="atomic-commit" width="1000" />
</div>

For the aggregation service, using the MapReduce framework is a good option:

<div style="margin-left:3rem">
    <img src="./images/ad-count-map-reduce.svg" alt="ad-count-map-reduce" width="1000" />
</div>

<div style="margin-left:3rem">
    <img src="./images/top-100-map-reduce.svg" alt="top-100-map-reduce" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/map-node.svg" alt="map-node" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/reduce-node.svg" alt="reduce-node" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/use-case-1.svg" alt="use-case-1" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/use-case-2.svg" alt="use-case-2" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/lambda-architecture.svg" alt="lambda-architecture" width="1000" />
</div>

Kappa architecture:

<div style="margin-left:3rem">
    <img src="./images/kappa-architecture.svg" alt="kappa-architecture" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/watermark-technique.svg" alt="watermark-technique" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/watermark-2.svg" alt="watermark-2" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/tumbling-window.svg" alt="tumbling-window" width="1000" />
</div>

As well as a sliding window for the top N clicked ads in M minutes aggregation:

<div style="margin-left:3rem">
    <img src="./images/sliding-window.svg" alt="sliding-window" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/data-duplication-example-1.svg" alt="data-duplication-example-1" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/data-duplication-example-2.svg" alt="data-duplication-example-2" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/data-duplication-example-3.svg" alt="data-duplication-example-3" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/scale-consumers.svg" alt="scale-consumers" width="1000" />
</div>

How do we scale the aggregation service?

<div style="margin-left:3rem">
    <img src="./images/aggregation-service-scaling.svg" alt="aggregation-service-scaling" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/multi-threading-example.svg" alt="multi-threading-example" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/cassandra-scalability.svg" alt="cassandra-scalability" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/hotspot-issue.svg" alt="hotspot-issue" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/fault-tolerance-example.svg" alt="fault-tolerance-example" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/fault-tolerance-recovery-example.svg" alt="fault-tolerance-recovery-example" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/reconciliation-flow.svg" alt="reconciliation-flow" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/alternative-design.svg" alt="alternative-design" width="1000" />
</div>
...
12. [Martin Kleppmann. Designing Data-Intensive Applications. O’Reilly Media, 2017.](https://www.oreilly.com/library/view/designing-data-intensive-applications/9781491903063/)
...
16. [Martin Kleppmann. Stream Processing. In Designing Data-Intensive Applications. O’Reilly Media, 2017.](https://www.oreilly.com/library/view/designing-data-intensive-applications/9781491903063/ch11.html)
...
20. [Apache Flink on YARN](https://nightlies.apache.org/flink/flink-docs-stable/docs/deployment/resource-providers/yarn/)
...
25. [Real-Time Exactly-Once Ad Event Processing with Apache Flink, Kafka, and Pinot](https://www.uber.com/us/en/blog/real-time-exactly-once-ad-event-processing/)
