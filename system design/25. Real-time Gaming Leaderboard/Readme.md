...
<div style="margin-left:3rem">
    <img src="./images/leaderboard.svg" alt="leaderboard" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/message-queue-based-comm.svg" alt="message-queue-based-comm" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/leaderboard-table.svg" alt="leaderboard-table" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/user-wins-point.svg" alt="user-wins-point" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/find-leaderboard-position.svg" alt="find-leaderboard-position" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/sorted-set.svg" alt="sorted-set" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/skip-list.svg" alt="skip-list" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/skip-list-performance.svg" alt="skip-list-performance" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/leaderboard-position-of-user.svg" alt="leaderboard-position-of-user" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/manage-services-ourselves.svg" alt="manage-services-ourselves" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/api-gateway-mapping.svg" alt="api-gateway-mapping" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/user-scoring-point-lambda.svg" alt="user-scoring-point-lambda" width="1000" />
</div>

Example user retrieving leaderboard:

<div style="margin-left:3rem">
    <img src="./images/user-retrieve-leaderboard.svg" alt="user-retrieve-leaderboard" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/range-partition.svg" alt="range-partition" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/hash-partition.svg" alt="hash-partition" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/top-10-players-calculation.svg" alt="top-10-players-calculation" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/dynamo-db.svg" alt="dynamo-db" width="1000" />
</div>

Let's start from a table for storing a leaderboard for a chess game:

<div style="margin-left:3rem">
    <img src="./images/chess-game-leaderboard-table-1.svg" alt="chess-game-leaderboard-table-1" width="1000" />
</div>

This works well, but doesn't scale well if we need to query anything by score. Hence, we can put the score as a sort key:

<div style="margin-left:3rem">
    <img src="./images/chess-game-leaderboard-table-2.svg" alt="chess-game-leaderboard-table-2" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/chess-game-leaderboard-table-3.svg" alt="chess-game-leaderboard-table-3" width="1000" />
</div>
...
<div style="margin-left:3rem">
    <img src="./images/scatter-gather-2.svg" alt="scatter-gather-2" width="1000" />
</div>
