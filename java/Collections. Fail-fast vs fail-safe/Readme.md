...
This article first compares the three behaviors, then explains safe modification and how to choose a collection.
...
![iteration-fail-fast-vs-weakly-consistent.svg](images/iteration-fail-fast-vs-weakly-consistent.svg)
...
![iteration-snapshot-vs-weakly-consistent.svg](images/iteration-snapshot-vs-weakly-consistent.svg)
