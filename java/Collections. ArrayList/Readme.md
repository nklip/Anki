...
This article builds the model in layers: storage and capacity → growth and cost → views and iteration → concurrency and choosing the right list.
...
![arraylist-memory-layout.svg](images/arraylist-memory-layout.svg)
...
![arraylist-growth.svg](images/arraylist-growth.svg)
...
![arraylist-insert-remove.svg](images/arraylist-insert-remove.svg)
