...
This article builds the model in four layers: heap organization → collection cycle → barriers that preserve correctness → production configuration and diagnosis.
...
![gc-zgc-collection-cycle.svg](images/gc-zgc-collection-cycle.svg)
...
![gc-zgc-colored-pointers-and-barriers.svg](images/gc-zgc-colored-pointers-and-barriers.svg)
