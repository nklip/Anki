...
Read this article from the overall map to stack-to-heap references, stack frames, collector-specific heap layouts, garbage-collection reachability, and finally diagnosis.

![jvm-memory-organization.svg](images/jvm-memory-organization.svg)
...
![jvm-stack-to-heap-references.svg](images/jvm-stack-to-heap-references.svg)
...
![jvm-thread-stack-frames.svg](images/jvm-thread-stack-frames.svg)
...
![gc-g1-memory-organization.svg](images/gc-g1-memory-organization.svg)
...
![gc-zgc-memory-organization.svg](images/gc-zgc-memory-organization.svg)
...
![jvm-gc-roots-and-reclamation.svg](images/jvm-gc-roots-and-reclamation.svg)
