...
**`CopyOnWriteArrayList` was introduced in Java 5 (JDK 1.5) as a thread-safe list in `java.util.concurrent`.**
...
![concurrency-copy-on-write-array-replacement.svg](images/concurrency-copy-on-write-array-replacement.svg)
