...
**Garbage-First (G1) became fully supported in Java SE 7u4.**
...
In current HotSpot, G1 is normally the default collector. This article first explains the region layout, then evacuation and remembered sets, and finally the Young-Only → marking → Mixed collection cycle.
...
![gc-g1-collection-cycle.svg](images/gc-g1-collection-cycle.svg)
...
- [Oracle Java SE 7 Update 4 Release Notes — Garbage First Collector](https://www.oracle.com/java/technologies/javase/7u4-relnotes.html)
