...
This article first follows one overwritten reference, then places that event in the full marking timeline, and finally explains floating garbage, new allocations, and how SATB differs from remembered-set barriers.
...
![gc-satb-pre-write-barrier.svg](images/gc-satb-pre-write-barrier.svg)
...
![gc-satb-marking-timeline.svg](images/gc-satb-marking-timeline.svg)
