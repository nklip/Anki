...
**Sequenced Collections were introduced in JDK 21 with JEP 431.**
...
![sequenced-collection-order-and-reversed-view.svg](images/sequenced-collection-order-and-reversed-view.svg)
