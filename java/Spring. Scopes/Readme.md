...
![spring-bean-scopes.svg](images/spring-bean-scopes.svg)

The article covers the two general scopes, the trap you hit when you mix lifetimes, then each web scope in turn.
...
![spring-web-scopes-lifecycle.svg](images/spring-web-scopes-lifecycle.svg)
